...
func Routers(app *fiber.App) {
	//quando entra no localhot8080, já faz a captura de todos os usuários cadastrados
	app.Get("/", user.GetAllUser)
	//quando entra no localhot8080/:id, faz a captura do usuário com Id passado como parâmetro
